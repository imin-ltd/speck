...
exports.ioTsBigInt = exports.ioTsJsDate = void 0;
/**
...
exports.ioTsBigInt = new t.Type('BigInt', (input) => typeof input === 'bigint', (input, context) => typeof input === 'bigint' ? t.success(input) : t.failure(input, context), t.identity);
