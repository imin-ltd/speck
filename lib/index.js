 ...
 */
exports.bigInt = createNonObjectSpeck(ioTsTypes_1.ioTsBigInt, fc.bigInt());
/**
 * `null` or `undefined`
 */
...
fc.object(), true);
exports.unknown = createNonObjectSpeck(t.unknown, fc.anything());
/** # Higher order types */
/**
 * Array of specks
 */
...
function nonEmptyArray(speck) {
    return createNonObjectSpeck((0, ioTsBrands_1.nonEmptyArray)(speck._ioTsType), fc.array(speck._fastCheckArbitrary, 1, 5));
}
