 ...
 * @template {[TStringOrNumber, TStringOrNumber, ...TStringOrNumber[]]} TStringOrNumbers 
 * 
 * @param {TStringOrNumbers} stringOrNumberLiteralsArray 
 */
function literalEnum(stringOrNumberLiteralsArray) {
  ...
  const fastCheckArbitrary = fc.oneof(...([literalA, literalB, ...literalsRest].map(s => s._fastCheckArbitrary)));
