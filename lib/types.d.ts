 ...
 * _TODO Docs to come_
 */
export type NonObjectSpeck<TUnderlyingType, TIoTsStaticType = TUnderlyingType> = BaseSpeck<TUnderlyingType, TIoTsStaticType> & {
 ...
 * `s.intersection()`
 */
export type ObjectSpeck<TUnderlyingType, TIoTsStaticType = TUnderlyingType> = BaseSpeck<TUnderlyingType, TIoTsStaticType> & {
...
export type Speck<TUnderlyingType, TIoTsStaticType = TUnderlyingType> = NonObjectSpeck<TUnderlyingType, TIoTsStaticType> | ObjectSpeck<TUnderlyingType, TIoTsStaticType>;
/** # API */
/**
...
export type RecordType<TKeySpeck extends NonObjectSpeck<string>, TValueSpeck extends Speck<any>> = ObjectSpeck<Record<TypeOf<TKeySpeck>, TypeOf<TValueSpeck>>>;
/**
...
export type IntersectionType<TObjectSpecks extends [ObjectSpeck<any>, ObjectSpeck<any>]> = ObjectSpeck<TypeOf<TObjectSpecks[0]> & TypeOf<TObjectSpecks[1]>>;
export type UnionObjectsType<TObjectSpecks extends [ObjectSpeck<any>, ObjectSpeck<any>]> = ObjectSpeck<TypeOf<TObjectSpecks[0]> | TypeOf<TObjectSpecks[1]>>;
export type UnionType<TSpecks extends [Speck<any>, Speck<any>]> = NonObjectSpeck<TypeOf<TSpecks[0]> | TypeOf<TSpecks[1]>>;
